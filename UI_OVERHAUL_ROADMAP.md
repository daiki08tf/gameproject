...
Remaining: Phase 3 (a real damage/loot/unlock/discovery feedback system, plus the systemic px→rem/`clamp()` dynamic-text retrofit Phase 1's audit named) before UIX-7 can be marked complete.

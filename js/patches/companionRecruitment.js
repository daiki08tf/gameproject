...
function resolveRecruitCandidate(candidate) {
  ...
  if (candidate.denlordId) opts = { minRarity: candidate.denlordSuper ? 'mythic' : candidate.denlordPrestige ? 'legendary' : 'epic', origin: 'denlordRecruit', enemyType: candidate.enemyType };

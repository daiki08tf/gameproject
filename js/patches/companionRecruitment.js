...
function resolveRecruitCandidate(candidate) {
  ...
  // 倒した個体の由来を保存する。Roamer > 地域Rare > Elite > 絆/巣窟 の順で
  // 珍しさの高い出自を採り、どの個体から来たかを origin に残す。
  if (candidate.roamerId) opts = { minRarity: 'epic', origin: 'roamerRecruit', enemyType: candidate.enemyType };

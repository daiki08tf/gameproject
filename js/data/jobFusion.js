...
const NEW_NAMES = {
  ...
  'priest+thief':'異端審問官','priest+merchant':'聖務官','priest+hunter':'退魔狩人','priest+ninja':'退魔忍','priest+dancer':'神楽巫女','priest+alchemist':'薬師','priest+scholar':'神学者','priest+craftsman':'結界師',
  'thief+bard':'トリックスター','thief+alchemist':'毒使い','thief+scholar':'遺物探究家','thief+farmer':'野伏','thief+craftsman':'仕掛師','thief+fortune':'イカサマ師',

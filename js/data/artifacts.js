...
export const RELICS = [
  {
    id: 'relic_bloodchalice', kind: 'relic', name: '血神の杯',
    desc: '通常攻撃・スキル命中時、ダメージの8%分ATKが3秒間上昇する（重複せず更新のみ）',
    trigger: 'onHit', kindEffect: 'bloodChalice', chance: 1.0, power: 0.08, duration: 3,
    abyssDepthRequired: 1, progressionEra: '深淵序層',
  },
  {
    id: 'relic_thundereye', kind: 'relic', name: '雷神の瞳',
    desc: '会心発生時、30%の確率でATKの40%の追加落雷ダメージが発生する',
    trigger: 'onCrit', kindEffect: 'lightning', chance: 0.3, power: 0.4,
    abyssDepthRequired: 100, progressionEra: '深淵中層',
  },
  {
    id: 'relic_berserkerheart', kind: 'relic', name: '狂戦士の心臓',
    desc: 'HPが低いほど攻撃速度が上昇し、HPが25%以下の間は通常攻撃が2回攻撃になる',
    trigger: 'passive', kindEffect: 'berserker', threshold: 0.25, power: 0.5,
    abyssDepthRequired: 500, progressionEra: '超越帯',
  },
  {
    id: 'relic_hourglass', kind: 'relic', name: '時喰らいの砂時計',
    desc: 'スキル使用時、25%の確率でクールダウンが発生しない',
    trigger: 'onSkill', kindEffect: 'cdRefund', chance: 0.25,
    abyssDepthRequired: 1000, progressionEra: '神域',
  },
  {
    id: 'relic_deathking', kind: 'relic', name: '死王の指骨',
    desc: '最大HPが30%減少する代わりに、極Affixの効果量が上昇する',
    trigger: 'passive', kindEffect: 'deathking', power: -0.3, affixBonus: 0.05,
    abyssDepthRequired: 2000, progressionEra: '終焉域',
  },
];

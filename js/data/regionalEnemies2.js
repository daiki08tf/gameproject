/* Enemy 2.0 E4 — Ch1–36 regional enemy expansion.
...
export const REGIONAL_ENEMY_EXPANSION = Object.freeze({
  ...
  ch36:entry('分岐選別体','系統照合師','二重像撹乱体','系統保持補助端末','未淘汰の分岐獣'),
  ...
  // Session 7 — Arc VIII 未記録帯。帳簿の外・未読の棚・野生の分岐・接続端。
  ch42:entry('座標残滓の徘徊体','記されぬ術師','帳簿外の撹乱体','畦道修復端末','記録外の畦獣'),

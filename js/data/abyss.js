...
import { curateAbyssEncounterStage } from './endgameEncounters2.js';
...
export function buildAbyssStage(rawDepth,pactIds=[],options={}){
 ...
 const level=abyssRecommendedLevel(depth),neutralTemplate=!!options?.suppressModifiers||!!options?.suppressEndgameRewards,progressionReward=neutralTemplate?{drop:1,gold:1,label:'suppressed'}:endgameRewardProfile(level);

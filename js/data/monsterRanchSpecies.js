...
export const RANCH_REGION_SPECIES=Object.freeze({...Object.fromEntries(ALL.flatMap((ch,i)=>['normal','fast'].map(role=>makeSpecies(ch,role,i)).filter(Boolean))),...RARE_SPECIES,...ROAMER_SPECIES,...DENLORD_SPECIES,...MACHINE_SPECIES,...PHASE12_RECRUITABLE_SPECIES});

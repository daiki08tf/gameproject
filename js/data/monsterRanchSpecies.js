...
const ROAMER_SPECIES=Object.freeze({
  ...
  roamer_glass_step:{id:'roamer_glass_step',name:'鏡歩き・GLASS STEP',type:'monster',family:'spirit',bondSkillId:'roamer_mirror',regionId:'wanderer',regionName:'名もなき強敵',enemyType:'roamer:glass_step',icon:'◆',baseStats:{hp:58,mp:16,atk:15,def:7,mag:9,spd:25},growth:{hp:5.5,mp:1.4,atk:2.2,def:.9,mag:1.4,spd:2.6},recruit:{baseChance:.12},field:['soar'],traits:['鏡歩'],skills:[{level:1,id:'bite'},{level:16,id:'sonic'},{level:28,id:'thunder_claw'}]},

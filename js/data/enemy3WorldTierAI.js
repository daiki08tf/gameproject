...
const ATTACKER_EXECUTE_HP=Object.freeze([.35,.37,.39,.41,.43,.45]);
const SUPPORT_FORCE_HEAL_HP=Object.freeze([.40,.42,.44,.46,.48,.50]);
const SUPPORT_HOLD_HEAL_HP=Object.freeze([.70,.72,.74,.76,.78,.80]);
const SYNERGY_TRIAGE_HP=Object.freeze([.55,.575,.60,.625,.65,.675]);

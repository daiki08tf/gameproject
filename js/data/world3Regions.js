/* Blade Vale — World 3.0 regional hierarchy
   The existing 20 chapters remain the authoritative stage data. This layer groups
   them into larger travel regions so the world UI does not become a flat chapter list. */

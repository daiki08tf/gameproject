 ...
 * Boss Encounter/phase and reward systems. It is intentionally not a
...
export const RAID_BOSSES = Object.freeze([
  Object.freeze({
    ...
    dangerTags: Object.freeze(['Guard', 'Phase', 'Resource']),
    mechanic: '七鍵守護機が王座を守る。位相反転のたびに攻撃・行動速度が跳ね上がる。',
    counterHint: '守護機を優先して排除し、位相反転直後の隙を逃さず攻めきる。終盤は長期戦を避ける。',

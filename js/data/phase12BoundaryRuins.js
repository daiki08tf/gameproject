...
function site({id,hiddenName='？？？',discoveredName,realmName,discoverDepth,clueDepth,fragmentSources,realmId,recLevel,itemPowerTarget,rule,rewardHint,inspectText,unlockedText}){
  return {id,hiddenName,discoveredName,realmName,discoverDepth,clueDepth,fragmentSources,fragmentsRequired:3,inspectText,unlockedText,realm:{id:realmId,recLevel,itemPowerTarget,rule,rewardHint}};
}

export const PHASE12_BOUNDARY_RUINS=Object.freeze({
  echo_observatory:{
    site:site({
      id:'echo_observatory',discoveredName:'反響だけが残る観測塔',realmName:'残響観測塔',discoverDepth:380,clueDepth:470,fragmentSources:[520,610,700],realmId:'secret-echo-observatory',recLevel:26000,itemPowerTarget:6800,
  ...
  drowned_foundry:{
    site:site({
      id:'drowned_foundry',hiddenName:'？？？？',discoveredName:'水没した鋳造昇降口',realmName:'沈降鋳造所',discoverDepth:760,clueDepth:880,fragmentSources:[960,1100,1250],realmId:'secret-drowned-foundry',recLevel:42000,itemPowerTarget:7800,
  ...
  memory_orchard:{
    site:site({
      id:'memory_orchard',hiddenName:'？？？？',discoveredName:'記憶果実の根穴',realmName:'記憶果樹園',discoverDepth:1320,clueDepth:1500,fragmentSources:[1650,1850,2050],realmId:'secret-memory-orchard',recLevel:62000,itemPowerTarget:9000,
  ...
  zero_station:{
    site:site({
      id:'zero_station',hiddenName:'？？？？？',discoveredName:'行先表示のない境界ホーム',realmName:'零番境界駅',discoverDepth:2050,clueDepth:2300,fragmentSources:[2450,2700,2950],realmId:'secret-zero-station',recLevel:90000,itemPowerTarget:9800,

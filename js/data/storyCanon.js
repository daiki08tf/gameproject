...
export const STORY_ARCS = Object.freeze([
  ...
  {id:'arc7',chapters:[40,41],name:'重層帯',purpose:'分岐核を畳み込もうとする機構を越えた先で、三つ以上の記録が同時に真として保持される帯と、分岐の芽が植えられ剪定される圃を辿る。',reveal:'分岐は自然発生ではなく管理されている——だが圃の管理者は蒔いた者ではない。分岐を始めた者、あるいはその先の座標はまだ見えない。'},
  {id:'arc8',chapters:[42,45],name:'未記録帯',purpose:'どの帳簿にも載らない座標域・誰にも読まれなかった記録の棚・管理囲いの外で野生に生えた分岐を辿り、全ての畦が静かに寄る接続端へ至る。',reveal:'記録の外にも世界は続いている——分岐は圃の外でも自生し、その先に繋がろうとした形跡だけが残る。接続先も接続者も、分岐を始めた者の座標も、まだどの記録にもない。'},
  {id:'arc9',chapters:[46,48],name:'応答層',purpose:'接続端を越えた先で、世界そのものがこちらへ応答し始める帯――応える畦、噂の集まる谷、全ての応答が流れ込む水源を辿る。',reveal:'噂とは世界からの返答だった——誰かが、あるいは何かが、ずっとこちらの声を聞いている。だが聴き手が「分岐を始めた者」と同じ存在なのか、それとも聞くことをやめられないだけの別の何かなのかは、まだ分からない。'},
]);
...
export const CLUE_LADDER = Object.freeze([
  ...
  {tier:8,label:'共観測',examples:['両側が独立に指す同じ第三の異常','数十拍だけ安定する第八鍵','協調観測','深緑の森の相互に両立しない二重輪郭']},
]);

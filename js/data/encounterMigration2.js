/* Enemy 2.0 E8 — progressive Ch1–35 Encounter Pool migration profiles. */
...
export function migrateStoryEncounterPools(chapters,enemyTypes){
  ...
  for(const chapter of chapters||[]){
    // Session 6/7/8: Arc VII（ch40–41）・Arc VIII（ch42–45）・Arc IX（ch46–48）も移行対象。
    // gaiden/探索地点は手書きencounterPool（棲み分け）を持つので移行しない。
    if(!chapter||chapter.num<1||chapter.num>48||chapter.gaiden)continue;

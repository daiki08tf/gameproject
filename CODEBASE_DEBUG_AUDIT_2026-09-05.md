...
- Rift remains the confirmed missing resolver/player-entry path (DBG-01).
...
1. **Runtime reachability:** finish DBG-09, then Rift Key, then every generated/endgame Stage builder vs actual selectable/startable path.

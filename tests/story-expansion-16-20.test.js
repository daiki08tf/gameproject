...
test('expanded chapter level ladder bridges chapter 15 to the original Lv700 boundary',()=>{
...
test('all chapter 16-20 stage enemy ids resolve including midbosses',()=>{
  for(let n=16;n<=20;n++){

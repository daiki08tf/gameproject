...
test('M11 introduces no branch tokens, portal-key currency, weekly resets, or parallel Item Power anywhere in the Observed Branches system', () => {
  const files = [
    ...
    'js/data/contentPackIVD.js', 'js/data/contentPackIVG.js', 'js/data/contentPackIVH.js',
    'js/patches/contentPackIVD.js', 'js/patches/contentPackIVG.js', 'js/patches/contentPackIVH.js',
  ];

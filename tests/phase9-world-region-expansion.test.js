...
test('Phase 9.1 expands story to 25 chapters',()=>{assert.equal(CHAPTERS.length,25);assert.deepEqual(CHAPTERS.slice(-5).map(ch=>ch.num),[21,22,23,24,25]);});

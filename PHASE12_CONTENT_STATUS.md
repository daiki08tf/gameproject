# Phase 12 — World Expansion / Horizontal Content Status
...
Phase 12 widens Blade Vale after the main vertical journey and Lv99,999 endgame spine are stable.

1. Optional content must never be required to advance the main story.
2. Reuse Adventure, exploration, Secret Realm, loot, Codex, Ranch and World Event routes before adding a new menu.
3. Every dungeon, enemy family, rare spawn or recruit needs a gameplay identity; avoid HP-only/color-only padding.
4. Side content may add **traces** of the central mystery, but must not reveal the main-story answer early.
5. Lore rewards should work as evidence: repeated symbols, impossible dates, outside-world materials, erased records, observer traces and boundary anomalies.
6. Recommended level and Item Power reuse canonical progression functions.
7. No new currency merely to make a content pack feel separate.
8. Ultra-rare rewards should be build-changing or collectible, not mandatory universal best-in-slot power.
